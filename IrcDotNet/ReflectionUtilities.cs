...
namespace IrcDotNet
{
    ...
    {
        public static IEnumerable<IrcDotNetTuple<TAttribute, TDelegate>> GetAttributedMethods<TAttribute, TDelegate>(
            this object obj)
            ...
            foreach (var methodInfo in messageProcessorsMethods)
            {
                ...
                if (methodAttributes.Length > 0)
                {
                    ...
                    foreach (var attribute in methodAttributes)
                        yield return IrcDotNetTuple.Create(attribute, methodDelegate);
                }
            }
        }
    }
