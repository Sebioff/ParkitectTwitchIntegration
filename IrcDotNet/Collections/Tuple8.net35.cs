...
{
    [Serializable]
    public class IrcDotNetTuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IIrcDotNetStructuralEquatable, IIrcDotNetStructuralComparable, IComparable
    {
        ...
        public IrcDotNetTuple(T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, TRest rest)
        {
            CheckType(rest);
            _item1 = item1;
            _item2 = item2;
        ...
        {
            var tuple = other as IrcDotNetTuple<T1, T2, T3, T4, T5, T6, T7, TRest>;
            if (tuple == null)
            {
                return false;
            }
        ...
        private static void CheckType(TRest rest)
        {
            ...
            throw new ArgumentException("The last element of an eight element tuple must be a IrcDotNetTuple.", "rest");
        }
