...
{
    [Serializable]
    public class IrcDotNetTuple<T1, T2, T3, T4> : IIrcDotNetStructuralEquatable, IIrcDotNetStructuralComparable, IComparable
    {
        ...
        public IrcDotNetTuple(T1 item1, T2 item2, T3 item3, T4 item4)
        {
            _item1 = item1;
            _item2 = item2;
            _item3 = item3;
        ...
        {
            var tuple = other as IrcDotNetTuple<T1, T2, T3, T4>;
            if (tuple == null)
            {
                return false;
            }
